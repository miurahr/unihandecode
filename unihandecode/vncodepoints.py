...
CODEPOINTS = { 
    ...
    'x35':[
        ...
        'Mau','You ','Hua ','Hung1','Chen ','Uong','Ng ','Hua ','Lap','Fa ','Hao ','Pou ','Dung6','Si ','','',
        'Le ','Lin ','Yi ','Hou ','Zaau1','Xu ','Qu ','Nhe','','','','','','','','Nei ',
        'Wei ','Xie ','Ti ','Hong ','Tun ','Bo ','Nie ','Sum','San2','','','','','','Wai ','Shou ',
        ...
        '','Boi','Ai ','Ci3','Hin1','Gou ','Thao','Bai ','Bo ','Na ','Trat','Xiao ','Suc','','','',
        '','','Rong','Ti ','Cu ','Kuo ','Lao ','Zhi ','Ai ','Xi ','','Qie ','Zaa1','Hei1','','',
        'Chu ','Ji ','Huo ','Ta ','Yan ','Xu ','Put3','Sai ','','','','Go6','Ye ','Xiang ','Heoi1','Xia ',
        ],
    'x36':[
        'Zuo ','Yi ','Ci ','','','Xian ','Tai ','Vang','Yi ','Zhi ','Yi ','Xian ','Ju ','Ji ','Han ','',
        'Pao ','Li ','','Ran','Can ','Han ','Yan ','','','Yan ','Han ','Haam1','Chi ','Nian ','Huo ','',
        ...
        'Yi ','Zung1','Man ','Zhang ','Ho','Gun ','','','Ji ','Liao ','Ye ','Ji ','Yin ','','Da ','Yi ',
        ...
        '','','','','','Ta ','Lan ','Man ','Qiang ','Zhou ','Em','Sek3','Lu ','Sik1','Sao ','Mian ',
    ...
    'x3a':[
        ...
        '','','Cam','Hui ','Tun ','Ling1','Qiang ','Xi ','Yi ','Nim2','Meng ','Tuan ','Giam','Hao ','Ci ','Zhai ',
    ...
    'x3b':[
        ...
        'Fang ','','','Ta ','Cui ','Sai1','De ','Ran ','Kuan ','Che ','Da ','Hu ','Cui ','Ro','Juan ','Lu ',
        'Qian ','Pao ','Zhen ','Fan1','Li ','Cao ','Qi ','','','Ti ','Ling ','Qu ','Lian ','Lu ','Shu ','Gong ',
        'Zhe ','Biao ','Cum','Qing ','','','Zong ','Buc','Jin ','Biao ','Jian ','Gun ','','Ban1','Zou1','Xop',
        ],
    'x3c':[
    ...
    'x3d':[
        ...
        'Faat1','Bao ','Loi','Ke ','Dian ','Bi ','Sui ','Ge ','Bi ','Yi ','Xian ','Ni ','Ying ','Zhu ','Chun ','Feng ',
    ...
    'x3f':[
        ...
        'Qie ','Shu ','Hoi1','Tuo ','Ru','Si ','Ran ','Mu ','Fu ','Ling ','Ji ','Xiu ','Xuan ','Nai ','At3','Jie ',
        ...
        'Hu ','Bei ','','','Zaa1','Ji ','Gu ','Sai1','Gao ','Chai ','Ma ','Zhu ','Tui ','Tui ','Hem','Lang ',
    ...
    'x40':[
        ...
        'Qu ','Xem','Shun ','Bi ','Mao ','Shuo ','Gu ','Hong ','Huan ','Luo ','Hang ','Jia ','Quan ','Goi1','Mang ','Bu ',
    ...
    'x42':[
        ...
        'Huan ','Gung1','Sai ','Zheng ','Qian ','Gan1','Zung1','Wei ','','','Xi ','Nap','Pu ','Huai ','Ju ','Zaan1',
        ...
        'Yue ','Bing ','Nou6','Zhou ','Bi ','Ren ','Luot','Gin1','Chuo ','Er ','Yi ','Mi ','Qing ','Zing1','Wang ','Ji ',
        'Bu ','Syu1','Bie ','Fan ','Yao ','Luoi','Moi','Qu ','Fu ','Er ','O1','Zang1','Zim1','Huo ','Jin ','Qi ',
    ...
    'x43':[
        ...
        'Qi ','Shi ','Bi ','Jue ','Si ','Taam1','Hua ','Da','Hui ','Kaap1','Er ','Caau3','Mou ','Zyu1','Xi ','Zhi ',
        'Ren ','Ju ','Die ','Zhe ','Teo','Meng ','Bi ','Han ','Yu ','Xian ','Pong1','Neng ','Can ','Bu ','Bong','Qi ',
        ],
    'x44':[
        ...
        'Meng ','Cao ','Tiao ','Kai ','Bai ','Xiao ','Xin ','Qi ','Seoi1','','Shao ','Heng ','Ngau','Xiao ','Chen ','Daan1',
    ...
    'x47':[
        ...
        'Yue ','Di ','Chen ','Chu ','Bi ','Mang ','Ba ','Tian ','Min ','Lie ','Feng ','Caang1','Kheo','Tiao ','Fu ','Kuo ',
    ...
    'x48':[
        ...
        'Song ','Xie ','Cang ','Yao ','Shu ','Yan ','Suot','Liao ','Sung1','Yu ','Bo ','Sui ','Cin1','Yan ','Lei ','Lin ',
    ...
    'x4c':[
        ...
        'Bao ','Vo','Zhen ','Xu ','Da ','Chi ','Gaai1','Cong ','Ma ','Kou ','Yan ','Can ','Aau1','He ','Dang1','Lan ',
        ],
    'x4d':[
    ...
    'x4f':[
        ...
        'Xia ','Xin ','Xiu ','Yu ','Ti ','Che ','Chou ','','Yan ','Lia ','Li ','Lai ','Si1','Jian ','Tu','Fu ',
    ...
    'x51':[
        ...
        'Guan ','Meng ','Zhong ','Ju ','Oan','Minh','Kou ','Lam1','Fu ','Xie ','Mi ','Bing ','Dong ','Tai ','Gang ','Feng ',
    ...
    'x53':[
        ...
        'Thai','Chi ','Su','You ','Qiu ','Po ','Xie ','Hao ','Ti','Tan ','Chi ','Le ','Diao ','Ji ','Duk1','Hong ',
        ],
    'x54':[
    ...
    'x55':[
        ...
        'Lao ','Liang ','Suo ','Zao ','Huan ','Laang1','Sha ','Ji ','Zuo ','Wo ','Feng ','Cam','Hu ','Qi ','Shou ','Wei ',
        ...
        'Luo ','Nham','Di ','Quan ','Tan ','Bo ','Ding ','Lang','Xiao ','Geoi1','Tang ','Chi ','Ti ','An ','Jiu ','Dan ',
    ...
    'x56':[
        ...
        'Ga ','Tang ','Ye ','Beng ','Ying ','Saai1','Jiao ','Mi ','Xiao ','Hua ','Mai ','Ran ','Choi','Peng ','Lao','Xiao ',
        ...
        'Liu ','Haai4','Nang ','Xiao ','Mo ','Yan ','Li ','Lo','Lung','Fu ','Dan ','Chen ','Pin ','Pi ','Xiang ','Huo ',
        ...
        'Za ','Chuc','Lan ','Nie ','Nang ','Trom','Lo1','Wei ','Hui ','Yin ','Tu','Si ','Nin ','Jian ','Hui ','Xin ',
    ...
    'x63':[
        ...
        'Ru ','Tiao ','Tret','Zha ','Lu ','Die ','Wa ','Jue ','Lyut3','Ju ','Zhi ','Luan ','Ya ','Zhua ','Ta ','Xie ',
        ...
        'Bai ','Shou ','Jie ','Lu ','Guo ','','','Zhi ','Dan ','Maang1','Xian ','Sao ','Guan ','Peng ','Yuan ','Nhac',
    ...
    'x64':[
        ...
        'Huan ','Jie ','Qin ','Kuai ','Dan ','Xi ','Ge ','Pi ','Bo ','Ao ','Co','Ye ','','Mang1','Sou ','Mi ',
    ...
    'x71':[
        ...
        'Wei ','Yi ','Xie ','Zhao ','Hui ','Tatsu ','Nung1','Lan ','Ru ','Xian ','Kao ','Hun','Jin ','Chou ','Dao ','Yao ',
        ],
    'x72':[
        ...
        '','Che ','Mi ','Tang ','Lan ','Zhu ','Laam5','Ling ','Cuan ','Yu ','Zhua ','Lam','Pa ','Tranh','Pao ','Cheng ',
        ...
        'Nghe','Li ','Du ','Lie ','Pi ','Piao ','Bao ','Xi ','Chou ','Wei ','Kui ','Chou ','Quan ','Hyun2','Ba ','Fan ',
    ...
    'x76':[
        ...
        'Ji ','Si','Yang ','Xian ','Jie ','Zheng ','Mak6','Li ','Huo ','Lai ','Shaku ','Dian ','Xuan ','Ying ','Yin ','Qu ',
    ...
    'x7e':[
        ...
        'Sui ','Fan ','Shuai ','Beng ','Yi ','Sao ','Mou ','Yao ','Qiang ','Hun ','Sen ','Xi ','Zung1','Xiu ','Ran ','Xuan ',
    ...
    'x82':[
        ...
        'Zong ','Bian ','Mao ','Die ','Dou6','Bang ','Cha ','Yi ','Sao ','Cang ','Tau','Lou ','Dai ','','Yao ','Tong ',
    ...
    'x88':[
        ...
        'Yin ','Trai','Lie ','','','Zhuang ','Dang ','Seot1','Kun ','Ken ','Niao ','Shu ','Jia ','Kun ','Cheng ','Li ',
    ...
    'x92':[
        ...
        'Yi ','Zhong ','Nie ','Gai ','Ri ','Huo ','Tai ','Kang ','Habaki ','Ro ','Ngaak3','','Duo ','Zi ','Ban','Tu ',
